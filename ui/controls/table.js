 ...
 * @param {Function} [params.onAdd] - 可选的添加函数，如果提供，将在表格后显示添加按钮
 * 
 ...
 * });
 */
function ColumedList({ field, iterator = [], colums = [], onAdd = null }) {
    ...
    if (onAdd && typeof onAdd === 'function') {
        ...
        addButtonContainer.className = "columed-list-add-container";

        const addButton = document.createElement("button");
        addButton.className = "columed-list-add-button";
        addButton.textContent = t("Add New") + " +";
