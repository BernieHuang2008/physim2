...
import { VarMon_report_simend, VarMon_report_vars, VarMon_report_ff, VarMon_reset } from "../ui/var_monitor.js";
...
class Simulation {
    ...
    simulate(dt = null) {
        ...
        VarMon_report_vars(this.world, this.time, vars);
        ...
        for (let obj_id in this.world.phyobjs) {
            ...
            if (ffd_ids.length === 1) {
                ...
                if (ffd_force) {
                    ...
                    // var Monitor Reporting
                    VarMon_report_ff(this.world, this.time, ffd_id, Math.hypot(ffd_force[0] || 0, ffd_force[1] || 0));
                } else {
        ...
        // 4. var Monitor Reporting
        VarMon_report_simend(this);
    }
